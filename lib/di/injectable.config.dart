...
import 'package:kare_kyoushi/navigator/main_navigator.dart' as _i11;
...
import 'package:kare_kyoushi/util/theme/theme_config.dart' as _i16;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> initGetIt({
    ...
    gh.factory<_i17.DebugPlatformSelectorViewModel>(
        () => _i17.DebugPlatformSelectorViewModel(gh<_i11.MainNavigator>()));
    gh.lazySingleton<_i18.FireBaseAnalyticsRepository>(
        () => _i18.FireBaseAnalyticsRepository(gh<_i8.FirebaseAnalytics>()));
    gh.factory<_i19.LicenseViewModel>(
        () => _i19.LicenseViewModel(gh<_i11.MainNavigator>()));
